  ...
  router.post('/', auth, async (req,res) => {
    ...
    try {
      const r = await db.query(
        'INSERT INTO tournaments (title,type,description,start_date,status,created_at,created_by) VALUES ($1,$2,$3,$4,$5,NOW(),$6) RETURNING *',
        [title,type||'single_elim',description||null,start_date||null,'draft', req.user.userId]
      );
      res.json(r.rows[0]);
    } catch(e){
      console.error(e);
